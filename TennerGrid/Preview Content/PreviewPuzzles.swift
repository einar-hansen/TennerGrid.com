//
//  PreviewPuzzles.swift
//  TennerGrid
//
//  Static puzzles for SwiftUI previews.
//  These are hardcoded to ensure previews work without loading from bundle.
//
...
enum PreviewPuzzles {
    ...
    static let easy3Row: TennerGridPuzzle = {
        TennerGridPuzzle(
            columns: 10,
            rows: 3,
            difficulty: .easy,
    ...
    static let easy5Row: TennerGridPuzzle = {
        TennerGridPuzzle(
            columns: 10,
            rows: 5,
            difficulty: .easy,
    ...
    /// Medium 10x4 puzzle
    static let medium4Row: TennerGridPuzzle = {
        TennerGridPuzzle(
            columns: 10,
            rows: 4,
            difficulty: .medium,
    ...
    static let medium5Row: TennerGridPuzzle = {
        TennerGridPuzzle(
            columns: 10,
            rows: 5,
            difficulty: .medium,
    ...
    /// Hard 10x5 puzzle
    static let hard5Row: TennerGridPuzzle = {
        TennerGridPuzzle(
            columns: 10,
            rows: 5,
            difficulty: .hard,
    ...
    static let hard6Row: TennerGridPuzzle = {
        TennerGridPuzzle(
            columns: 10,
            rows: 6,
            difficulty: .hard,
    ...
    static let hard7Row: TennerGridPuzzle = {
        TennerGridPuzzle(
            columns: 10,
            rows: 7,
            difficulty: .hard,
